    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 dark:from-slate-900 dark:to-purple-900">
      ...
      <div className="container mx-auto px-6 py-8 space-y-8">
        ...
        <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg border-0 rounded-3xl shadow-xl">
          ...
          <CardContent className="space-y-6">
            {/* Theme Toggle */}
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-50 to-purple-50 dark:from-slate-700 dark:to-purple-800 rounded-2xl">
            ...
            <div className="space-y-2">
              ...
              <Select value={language} onValueChange={(value: 'ru' | 'uz' | 'en') => setLanguage(value)}>
                <SelectTrigger className="h-12 rounded-xl border-2 bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm">
                  <SelectValue />
                </SelectTrigger>
            ...
            {/* Notifications */}
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-700 dark:to-blue-800 rounded-2xl">
              <div className="flex items-center space-x-3">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            variant="outline"
            className="w-full h-14 rounded-2xl border-2 border-red-300 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
          >
